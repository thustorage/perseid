...
class masstree {
    ...
    public:
        ...
        void put(const Slice &key, uint64_t value,
        ...
        int scan(const Slice &min, const Slice &max, int num,
...
class leafnode {
    ...
    public:
        ...
        void get_range(leafvalue *&min_lv, leafvalue *&max_lv, int num,
        ...
        leafvalue *max_leaf(size_t key_len, uint64_t value);
