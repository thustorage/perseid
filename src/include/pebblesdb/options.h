...
struct ReadOptions {
  ...
  int num_records;
  int num_scan_pkey_cnt = 5;
  int num_sec_probe = 0;
  int num_pri_probe = 0;
  uint64_t time_pdb = 0;
  uint64_t time_validate = 0;
  uint64_t time_pri_file_io = 0;
  ...
  void MergeStats(const ReadOptions &other) {
    num_sec_probe += other.num_sec_probe;
    num_pri_probe += other.num_pri_probe;
    time_pdb += other.time_pdb;
    time_validate += other.time_validate;
    time_pri_file_io += other.time_pri_file_io;
  }
};
