...
class DB {
 public:
  ...
  virtual Status Get(const ReadOptions& options, const Slice& key,
                     std::string* value, uint64_t* pseq = nullptr) = 0;

  // secondary index
  virtual Status PutWithSec(const WriteOptions& options, const Slice& pkey,
                            const Slice& skey, const Slice& value) = 0;
  // virtual Status Put(const WriteOptions& options, const Slice& value) = 0;
  virtual Status SecGetPKeyOnly(const ReadOptions& options, const Slice& skey,
                                std::vector<std::string>* value_list) = 0;
  virtual Status SecGet(const ReadOptions& options, const Slice& skey,
                        std::vector<KeyValuePair>* value_list) = 0;
  virtual Status SecScanPKeyOnly(const ReadOptions& options, const Slice& skey,
                                 std::vector<std::string>* pkey_list) = 0;
 ...
 private:
  ...
  virtual Status LSMSGet(const ReadOptions& options, const Slice& skey,
                         std::vector<KeyValuePair>* value_list, DB* db,
                         DB* pri_key_index) = 0;
  virtual Status LSMSGetPKeyOnly(const ReadOptions& options, const Slice& skey,
                                 std::vector<std::string>* pkey_list,
                                 DB* pri_db, DB* pri_key_index) = 0;
  virtual Status ParallelSGet(const ReadOptions& options, const Slice& skey,
                              std::vector<KeyValuePair>* value_list, DB* db,
                              DB* pri_key_index) = 0;
  virtual Status LSMSScanPKeyOnly(const ReadOptions& options, const Slice& skey,
                                  std::vector<std::string>* pkey_list,
                                  DB* pri_db, DB* pri_key_index) = 0;
};
